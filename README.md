...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q1y16fk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q1y16fk.containers.anotherwebservice.com/
...
```
git clone git@github.com:p51mustang666/container-q1y16fk.git
cd container-q1y16fk
```
...
```
docker attach container-q1y16fk
```
